...
const List listaExamen=[
  ...
  '1#5 #Comprar pastel #Pasar a la pastelería para comprar un pastel de chocolate#5',
  '2#6 #Tarea de Criptografia #Subir la tarea 2 a didactic #4',
  ...
  '7#11 #Apuntes de criptografia #Completar apuntes del parcial#1',
  '8#12 #Limpieza #Limpieza de la casa, cocina baños y cuarto#3',
  '9#13 #Examen de Administracion #Estudiar para el examen de administracion#1',
  '10#14 #Lavar ropa #Meter a lavar la ropa blanca #2',
  '11#15 #Salida con amigas #Acordar la hora y lugar de la salida #2',
  '12#16 #Leer libro #Comenzar el nuevo libro #1',
